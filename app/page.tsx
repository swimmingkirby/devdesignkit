    ...
    <div className="min-h-screen bg-[#2C2C2C] text-white flex flex-col font-sans selection:bg-blue-500/30">
      ...
      <main className="flex-1 flex flex-col lg:flex-row items-center justify-center container mx-auto px-4 py-12 lg:py-24 gap-12 lg:gap-24">
        ...
        <div className="flex-1 space-y-8 max-w-2xl text-center lg:text-left">
          ...
          {/* Badge / Label (Optional but adds to the "premium" feel) */}
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
            ...
            <Link href="/examples">
              <Button variant="outline" size="lg" className="w-full sm:w-auto border-[#444] text-gray-300 hover:text-white hover:bg-[#3C3C3C] h-12 px-8 text-base">
                View Examples
              </Button>
            </Link>
          </div>
        ...
        <div className="flex-1 w-full max-w-xl lg:max-w-none relative">
          ...
          <Card className="relative bg-[#1E1E1E] border-[#333] shadow-2xl rounded-xl overflow-hidden">
            {/* Mock Window Header */}
            <div className="h-10 bg-[#252525] border-b border-[#333] flex items-center px-4 gap-2">
            ...
            <div className="p-6 space-y-8">
              ...
              <div className="space-y-3">
                ...
                <div className="h-24 rounded-lg w-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 shadow-inner border border-white/5 relative overflow-hidden">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-[#111] rounded-lg border border-[#333] p-4 space-y-4">
                  <div className="space-y-2">
                    <Label className="text-gray-300">Email Address</Label>
                    <Input
                      placeholder="Enter your email"
                      className="bg-[#1E1E1E] border-[#444] text-gray-300 focus-visible:ring-blue-500/50"
                      readOnly
                    />
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button variant="secondary" className="bg-[#333] hover:bg-[#444] text-white flex-1">
                      Log In
                    </Button>
                  </div>
              ...
              <div className="flex items-center gap-3 pt-2">
                <div className="h-9 flex-1 bg-[#252525] rounded border border-[#333] flex items-center px-3 text-xs text-gray-500 font-mono">
                  <Download className="h-3 w-3 mr-2" />
                  Copy Code
                </div>
                <div className="h-9 px-3 rounded border border-[#333] flex items-center text-xs text-gray-500">
                  CSS
                </div>
              </div>
            </div>
